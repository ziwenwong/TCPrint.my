...
const customerStorageKey = "printkingCustomerDetails";
const siteName = "Printking.my";
const siteUrl = "https://printking.my/";
const defaultSeo = {
  title: "Printking.my | Sticker, Banner & Bunting Printing Service Malaysia",
  description:
    "Printking.my provides custom sticker, label sticker, banner, bunting stand and large format printing services in Kulai, Johor Bahru and Malaysia. Order via WhatsApp.",
  keywords:
    "Printking.my, Printking, printing service Malaysia, custom sticker Kulai, label sticker Johor Bahru, banner printing Johor, bunting stand printing Malaysia, large format printing, custom printing",
  url: siteUrl,
  image: "assets/images/printking-logo.png",
};

const sectionSeo = {
  "#printing": {
    title: "Printing Services Malaysia | Printking.my",
    description:
      "Browse Printking.my services including custom sticker, label sticker, banner, bunting stand and large format printing in Kulai, Johor Bahru and Malaysia.",
    keywords:
      "printing services Malaysia, sticker printing Kulai, banner printing Johor Bahru, bunting stand Johor, custom printing Malaysia",
    url: `${siteUrl}#printing`,
    image: "assets/images/label-sticker.png",
  },
  "#portfolio": {
    title: "Our Works | Printking.my Printing Portfolio",
    description:
      "View Printking.my portfolio placeholders for sticker, banner, bunting, poster and shop decoration printing works.",
    keywords: "Printking.my portfolio, Printking portfolio, printing works Johor, sticker works, banner works, bunting works",
    url: `${siteUrl}#portfolio`,
    image: "assets/images/banner.png",
  },
  "#about": {
    title: "About Printking.my | Printing Service in Kulai Johor",
    description:
      "Printking.my is a printing service in Kulai, Johor serving Johor Bahru, Johor and Malaysia with stickers, banners, bunting stands and custom printing.",
    keywords: "about Printking.my, about Printking, printing service Kulai, Johor printing company, Johor Bahru printing service",
    url: `${siteUrl}#about`,
    image: "assets/images/printking-logo.png",
  },
  "#contact": {
    title: "Contact Printking.my | WhatsApp Printing Order",
    description:
      "Contact Printking.my for sticker, banner, bunting stand and custom printing orders in Kulai, Johor Bahru, Johor and Malaysia.",
    keywords: "contact Printking.my, contact Printking, WhatsApp printing order, Kulai printing contact, Johor Bahru printing",
    url: `${siteUrl}#contact`,
    image: "assets/images/printking-logo.png",
  },
};
...
const productCategories = [
  {
    ...
    description: "Interactive sticker order with size, shape, material, lamination and price estimate.",
    priceLabel: "From RM0.07/pcs",
    mode: "sticker",
    group: "sticker",
    image: "assets/images/label-sticker.png",
    preset: { stickerType: "Label Sticker" },
  },
  {
    id: "large-format-sticker",
    title: "Large Format Sticker",
    category: "Sticker Printing",
    subtitle: "Custom size large format sticker with square-foot pricing.",
    description: "Same sticker options as Label Sticker, with custom size only and RM1.80/sq ft estimate.",
    priceLabel: "RM1.80/sq ft",
    mode: "large-sticker",
    group: "sticker",
    image: "assets/images/large-format-sticker.png",
    preset: { stickerType: "Large Format Sticker", customWidth: 100, customHeight: 100 },
  },
  {
    id: "waterproof-sticker",
    title: "Waterproof Sticker",
    category: "Sticker Printing",
    subtitle: "Waterproof stickers for bottles, jars, packaging and product labels.",
    description: "Interactive sticker order with size, shape, material, lamination and price estimate.",
    priceLabel: "From RM0.07/pcs",
    mode: "sticker",
    group: "sticker",
    image: "assets/images/label-sticker.png",
    preset: { stickerType: "Waterproof Sticker" },
  },
  {
    id: "light-box-sticker",
    title: "Light Box Sticker",
    category: "Sticker Printing",
    subtitle: "Custom light box sticker with automatic cm to square-foot price estimate.",
    description: "Custom size and quantity light box sticker calculated at RM6/sq ft.",
    priceLabel: "RM6/sq ft",
    mode: "lightbox-sticker",
    group: "sticker",
    image: "assets/images/light-box-sticker.png",
    preset: { stickerType: "Light Box Sticker", customWidth: 100, customHeight: 100 },
  },
  {
    id: "foam-board-mounting",
    ...
    priceLabel: "RM4.80/sq ft",
    mode: "foamboard",
    group: "sticker",
    image: "assets/images/foamboard-mounting.png",
  },
  {
    id: "h-shape-display-stand",
    title: "H Shape Display Stand",
    category: "Display Stand",
    subtitle: "H shape stand with printing sticker and foam board mounting.",
    description: "Calculated with RM28/pcs stand fee plus sticker and foam board square-foot cost.",
    priceLabel: "RM28/pcs + RM4.80/sq ft",
    mode: "foamboard",
    group: "sticker",
    image: "assets/images/h-shape-display-stand.png",
  },
  {
    id: "banner",
    title: "Banner",
  ...
  },
  {
    ...
    mode: "generic",
    group: "business",
    image: "assets/images/business-card.png",
  },
  {
    ...
    mode: "generic",
    group: "custom",
    image: "assets/images/custom-size-printing.png",
  },
  {
    id: "other-printing",
...
const moneyThreeDecimals = new Intl.NumberFormat("en-MY", {
  style: "currency",
  currency: "MYR",
...
const selectors = {
  ...
  productFilterList: document.querySelector("#productFilterList"),
  ...
  productSeoHeading: document.querySelector("#productSeoHeading"),
  ...
  stickerSizeField: document.querySelector("#stickerSizeField"),
  ...
  stickerLaminationSelect: document.querySelector("#stickerLaminationSelect"),
  ...
  foamboardLamination: document.querySelector("#foamboardLamination"),
...
function formatMoneyThreeDecimals(value) {
  return moneyThreeDecimals.format(Number(value || 0)).replace("MYR", "RM");
}
...
function isCustomStickerProduct(product = activeProduct()) {
  return product.mode === "large-sticker" || product.mode === "lightbox-sticker";
}

function isStickerControlMode(mode) {
  return mode === "sticker" || mode === "large-sticker" || mode === "lightbox-sticker";
}
...
function productSeo(product) {
  return {
    title: `${product.title} Printing Service Malaysia | Printking.my`,
    description: `${product.title} printing service by Printking.my for Kulai, Johor Bahru, Johor and Malaysia. Send your artwork and order details via WhatsApp.`,
    keywords: `Printking.my, Printking, ${product.title}, ${product.title} printing, printing service Kulai, printing service Johor Bahru, Johor printing, Malaysia printing`,
...
function applySeo(seo) {
  ...
  const imageUrl = absoluteUrl(pageSeo.image);

  document.title = pageSeo.title;
  updateMeta('meta[name="description"]', pageSeo.description);
  updateMeta('meta[name="keywords"]', pageSeo.keywords);
  updateMeta('link[rel="canonical"]', pageSeo.url, "href");
  updateMeta('meta[property="og:site_name"]', siteName);
  updateMeta('meta[property="og:title"]', pageSeo.title);
  updateMeta('meta[property="og:description"]', pageSeo.description);
  updateMeta('meta[property="og:url"]', pageSeo.url);
  updateMeta('meta[property="og:image"]', imageUrl);
  updateMeta('meta[name="twitter:title"]', pageSeo.title);
  updateMeta('meta[name="twitter:description"]', pageSeo.description);
  updateMeta('meta[name="twitter:image"]', imageUrl);
}

function updateSeoForLocation(product = null) {
  if (product) {
    applySeo(productSeo(product));
    return;
  }

  const hash = location.hash || "#home";
  const productId = new URLSearchParams(hash.replace(/^#/, "")).get("product");
  const hashProduct = productCategories.find((item) => item.id === productId);

  if (hashProduct) {
    applySeo(productSeo(hashProduct));
    return;
  }

  applySeo(sectionSeo[hash] || defaultSeo);
}
...
function productCountByFilter(filterId) {
  if (filterId === "all") return productCategories.length;
  return productCategories.filter((product) => product.group === filterId).length;
}

function visibleProductCategories() {
  if (state.productFilter === "all") return productCategories;
  return productCategories.filter((product) => product.group === state.productFilter);
}

function renderProductFilters() {
  selectors.productFilterList.innerHTML = productFilters
    .map((filter) => {
      const isActive = filter.id === state.productFilter;
      return `
        <button
          class="product-filter-button ${isActive ? "active" : ""}"
          type="button"
          data-product-filter="${filter.id}"
          aria-pressed="${isActive}"
        >
          <span>${filter.label}</span>
          <strong>${productCountByFilter(filter.id)}</strong>
        </button>
      `;
    })
    .join("");

  selectors.productFilterList.querySelectorAll("[data-product-filter]").forEach((button) => {
...
function renderProductCategories() {
  selectors.categoryGrid.innerHTML = visibleProductCategories().map(renderProductCategoryCard).join("");
  ...
  selectors.categoryGrid.querySelectorAll("[data-product-card]").forEach((card) => {
    card.classList.toggle("active", card.dataset.productCard === state.activeProductId);
  });
}
...
function getStickerQuantity() {
  if (isCustomStickerProduct()) {
    return integerValue(selectors.customStickerQuantity, 1);
  }
...
function calculateStickerPrice(product) {
  ...
  const lamination = selectedText(selectors.stickerLaminationSelect);
...
function calculateLargeFormatStickerPrice(product) {
  const width = numericValue(selectors.customStickerWidth, 100);
  const height = numericValue(selectors.customStickerHeight, 100);
  const quantity = getStickerQuantity();
  const unit = 1.8;
  const area = areaInSquareFeet(width, height, "cm");
  const printing = area * unit * quantity;
  const postage = deliveryCost();
  const shape = selectedText(selectors.stickerShapeSelect);
  const material = selectedText(selectors.stickerMaterialSelect);
  const lamination = selectedText(selectors.stickerLaminationSelect);
  ...
  return {
    ...
    lamination,
    unit,
    unitLabel: `${formatMoney(unit)} / sq ft`,
    printing,
    postage,
    total: printing + postage,
    note: "Large format sticker is calculated at RM1.80/sq ft. Size in cm is converted to square feet automatically. Final price depends on artwork and finishing.",
  };
}

function calculateLightBoxStickerPrice(product) {
  const width = numericValue(selectors.customStickerWidth, 100);
  const height = numericValue(selectors.customStickerHeight, 100);
  const quantity = getStickerQuantity();
  const unit = 6;
  ...
  return {
    ...
    postage,
    total: printing + postage,
    note: "Light box sticker is calculated at RM6/sq ft. Size in cm is converted to square feet automatically. Final price depends on artwork and finishing.",
  };
}
...
function calculateFoamboardPrice(product) {
  ...
  return {
    ...
    material: thickness,
    lamination,
    usage: isStand ? "H Shape Display Stand" : "Display / Signage Mounting",
    unitLabel: isStand
      ? `${formatMoney(unitPrice)} / sq ft + ${formatMoney(standUnit)} / pcs`
      : `${formatMoney(unitPrice)} / sq ft`,
    printing,
    addon,
    postage,
    total: printing + addon + postage,
    note: isStand
      ? "H Shape Display Stand adds RM28/pcs. Sticker RM1.80/sq ft + Foam Board 5mm RM3/sq ft. Final price depends on artwork and finishing."
      : "Printing sticker RM1.80/sq ft + Foam Board 5mm RM3/sq ft. Final price depends on artwork and finishing.",
  };
}
...
function calculateBuntingPrice(product) {
  ...
  const buntingStyle = selectors.buntingType.value === "normal" ? "hanging" : "roll";
...
function calculateCurrentOrder() {
  ...
  if (product.mode === "large-sticker") return calculateLargeFormatStickerPrice(product);
  if (product.mode === "lightbox-sticker") return calculateLightBoxStickerPrice(product);
...
function estimatedPriceMessage(result) {
  ...
  const suffix =
    result.mode === "sticker" ||
    result.mode === "large-sticker" ||
    result.mode === "lightbox-sticker" ||
...
function showControls(mode) {
  selectors.stickerControls.hidden = !isStickerControlMode(mode);
...
function updateStickerPreview(result) {
  const selectedSize =
    isCustomStickerProduct(result.product)
      ? {
          width: Math.max(1, Number(selectors.customStickerWidth.value) || 100),
          height: Math.max(1, Number(selectors.customStickerHeight.value) || 100),
        }
      : getStickerSize();
  ...
  selectors.mockupObject.className = "mockup-object jar";
  ...
  selectors.previewStatus.textContent = `${result.size} / ${result.shape}`;
  selectors.previewTitle.textContent = `${result.type} mockup`;
  selectors.previewDescription.textContent =
    "Preview changes based on selected size and shape. You can replace this mockup with real product photos later.";
}

function updateBasicPreview(result) {
  let className = "generic-print";
  if (result.mode === "banner") className = "banner-print";
  if (result.mode === "bunting") {
    className = result.buntingStyle === "hanging" ? "bunting-hanging" : "bunting-roll";
  }

  selectors.mockupObject.className = `mockup-object ${className}`;
  selectors.stickerShapePreview.hidden = false;
  selectors.stickerShapePreview.className = "sticker-shape rectangle";
  selectors.stickerShapePreview.style.setProperty("--sticker-w", result.mode === "bunting" ? "132px" : "190px");
  selectors.stickerShapePreview.style.setProperty("--sticker-h", result.mode === "bunting" ? "250px" : "112px");
  selectors.stickerSizeBadge.textContent = result.mode === "bunting" ? result.size : result.product.title;
  selectors.previewStatus.textContent =
    result.mode === "bunting"
      ? `${result.type} / ${result.quantity} pcs`
      : `${result.product.title} / ${result.quantity} pcs`;
  selectors.previewTitle.textContent =
    result.mode === "bunting" ? `${result.type} preview` : `${result.product.title} preview`;
  selectors.previewDescription.textContent =
    result.mode === "bunting"
      ? "Preview changes based on the selected bunting type."
...
function renderInteractiveProductPreview(result) {
  if (isStickerControlMode(result.mode)) {
  ...
  const buntingImage =
    result.mode === "bunting" && result.buntingStyle === "hanging"
      ? "assets/images/bunting-hanging.png"
      : product.image;
  selectors.referenceImage.src = buntingImage || "assets/images/other-printing.png";
  selectors.referenceImage.alt = `${product.title} reference`;
}

function syncFormVisibility() {
  const product = activeProduct();
  const isCustomSticker = isCustomStickerProduct(product);
  ...
  selectors.stickerSizeField.hidden = isCustomSticker;
  selectors.customSizeFields.hidden = !(isCustomStickerSize || isCustomSticker);
  selectors.stickerQuantitySelect.hidden = isCustomSticker;
  selectors.customStickerQuantity.hidden = !(isCustomStickerQuantity || isCustomSticker);
  ...
  if (!isCustomStickerQuantity && !isCustomSticker) {
...
function setActiveProduct(productId, shouldScroll = false, shouldUpdateHash = true) {
  ...
  selectors.productSeoHeading.textContent = `${product.title} Printing Service`;
  ...
  if (product.preset?.customWidth) selectors.customStickerWidth.value = product.preset.customWidth;
  if (product.preset?.customHeight) selectors.customStickerHeight.value = product.preset.customHeight;
  if (isCustomStickerProduct(product)) selectors.customStickerQuantity.value = "1";
  ...
  if (shouldUpdateHash && location.hash !== `#product=${product.id}`) {
    history.replaceState(null, "", `#product=${product.id}`);
  }

  if (shouldUpdateHash) {
    updateSeoForLocation(product);
  }
...
function loadSavedCustomerDetails() {
  try {
    ...
    selectors.customerName.value = saved.name || "";
    selectors.customerPhone.value = saved.phone || "";
    selectors.customerEmail.value = saved.email || "";
    selectors.customerAddress.value = saved.address || "";
  } catch {
...
function saveCustomerDetails() {
  const details = {
    ...
    address: selectors.customerAddress.value.trim(),
  };

  try {
    localStorage.setItem(customerStorageKey, JSON.stringify(details));
  } catch {
    // Customer details still work for the current order if localStorage is unavailable.
  }
}
...
function buildWhatsAppMessage(result) {
  ...
  if (result.usage) {
    lines.splice(8, 0, `Usage: ${result.usage}`);
  }

  if (result.addon) {
    lines.splice(7, 0, `Add-on: ${formatMoney(result.addon)}`);
  }
...
function validateOrderForm() {
  ...
  if (
    (product.mode === "sticker" && selectors.stickerSizeSelect.value === "custom") ||
    isCustomStickerProduct(product)
  ) {
  ...
  if (
    (product.mode === "sticker" && selectors.stickerQuantitySelect.value === "custom") ||
    isCustomStickerProduct(product)
  ) {
...
function bindFormEvents() {
  [
    ...
    selectors.stickerLaminationSelect,
  ...
  selectors.remarkInput.addEventListener("input", clearValidationState);
...
function bindHashRouting() {
  window.addEventListener("hashchange", () => {
    ...
    if (productId) {
      setActiveProduct(productId, true);
      return;
    }
...
function lockUnavailableOptions() {
  [selectors.stickerLaminationSelect, selectors.foamboardLamination].forEach((select) => {
    select.value = "None";
...
function initFromHash() {
  ...
  setActiveProduct("label-sticker", false, false);
  updateSeoForLocation();
}
