...
const customerStorageKey = "tcprintCustomerDetails";
const siteName = "TCprint.my";
const siteUrl = "https://tcprint.my/";
const defaultSeo = {
  title: "TCprint.my | Sticker, Banner & Bunting Printing Service Malaysia",
  description:
    "TCprint.my provides custom sticker, label sticker, banner, bunting stand and large format printing services in Kulai, Johor Bahru and Malaysia. Order via WhatsApp.",
  keywords:
    "TCprint.my, TC Print, printing service Malaysia, custom sticker Kulai, label sticker Johor Bahru, banner printing Johor, bunting stand printing Malaysia, large format printing, custom printing",
  url: siteUrl,
  image: "assets/images/tc-creative-print-logo.png",
};

const sectionSeo = {
  "#printing": {
    title: "Printing Services Malaysia | TCprint.my",
    description:
      "Browse TCprint.my services including custom sticker, label sticker, banner, bunting stand and large format printing in Kulai, Johor Bahru and Malaysia.",
    keywords:
  ...
  "#portfolio": {
    title: "Our Works | TCprint.my Printing Portfolio",
    description:
      "View TCprint.my portfolio placeholders for sticker, banner, bunting, poster and shop decoration printing works.",
    keywords: "TCprint.my portfolio, TC Print portfolio, printing works Johor, sticker works, banner works, bunting works",
    url: `${siteUrl}#portfolio`,
    image: "assets/images/banner.png",
  },
  "#about": {
    title: "About TCprint.my | Printing Service in Kulai Johor",
    description:
      "TCprint.my is a printing service in Kulai, Johor serving Johor Bahru, Johor and Malaysia with stickers, banners, bunting stands and custom printing.",
    keywords: "about TCprint.my, about TC Print, printing service Kulai, Johor printing company, Johor Bahru printing service",
    url: `${siteUrl}#about`,
    image: "assets/images/tc-creative-print-logo.png",
  },
  "#contact": {
    title: "Contact TCprint.my | WhatsApp Printing Order",
    description:
      "Contact TCprint.my for sticker, banner, bunting stand and custom printing orders in Kulai, Johor Bahru, Johor and Malaysia.",
    keywords: "contact TCprint.my, contact TC Print, WhatsApp printing order, Kulai printing contact, Johor Bahru printing",
    url: `${siteUrl}#contact`,
    image: "assets/images/tc-creative-print-logo.png",
  },
};
...
function productSeo(product) {
  return {
    title: `${product.title} Printing Service Malaysia | TCprint.my`,
    description: `${product.title} printing service by TCprint.my for Kulai, Johor Bahru, Johor and Malaysia. Send your artwork and order details via WhatsApp.`,
    keywords: `TCprint.my, TC Print, ${product.title}, ${product.title} printing, printing service Kulai, printing service Johor Bahru, Johor printing, Malaysia printing`,
