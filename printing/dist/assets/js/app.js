...
const siteName = "TC Print";
const siteUrl = "https://tc-print-my.vercel.app/";
const defaultSeo = {
  title: "TC Print Malaysia | Sticker, Banner & Bunting Printing Service",
  description:
    "TC Print provides waterproof sticker, label sticker, banner and bunting stand printing services in Kulai, Johor Bahru and Malaysia. Order via WhatsApp.",
  keywords:
    "TC Print, printing service Malaysia, waterproof sticker Kulai, label sticker Johor Bahru, banner printing Johor, bunting stand printing Malaysia, custom printing",
  url: siteUrl,
...
const sectionSeo = {
  "#printing": {
    title: "Printing Services Malaysia | TC Print",
    description:
      "Browse TC Print services including waterproof sticker, label sticker, banner, bunting stand and custom printing in Kulai, Johor Bahru and Malaysia.",
    keywords:
  ...
  "#portfolio": {
    title: "Our Works | TC Print Printing Portfolio",
    description:
      "View TC Print portfolio placeholders for sticker, banner, bunting, poster and shop decoration printing works.",
    keywords: "TC Print portfolio, printing works Johor, sticker works, banner works, bunting works",
    url: `${siteUrl}#portfolio`,
    image: "assets/images/banner.png",
  },
  "#about": {
    title: "About TC Print | Printing Service in Kulai Johor",
    description:
      "TC Print is a printing service in Kulai, Johor serving Johor Bahru, Johor and Malaysia with stickers, banners, bunting stands and custom printing.",
    keywords: "about TC Print, printing service Kulai, Johor printing company, Johor Bahru printing service",
    url: `${siteUrl}#about`,
    image: "assets/images/tc-creative-print-logo.png",
  },
  "#contact": {
    title: "Contact TC Print | WhatsApp Printing Order",
    description:
      "Contact TC Print for sticker, banner, bunting stand and custom printing orders in Kulai, Johor Bahru, Johor and Malaysia.",
    keywords: "contact TC Print, WhatsApp printing order, Kulai printing contact, Johor Bahru printing",
    url: `${siteUrl}#contact`,
    image: "assets/images/tc-creative-print-logo.png",
  },
};
...
function productSeo(product) {
  return {
    title: `${product.title} Printing Service Malaysia | TC Print`,
    description: `${product.title} printing service by TC Print for Kulai, Johor Bahru, Johor and Malaysia. Send your artwork and order details via WhatsApp.`,
    keywords: `TC Print, ${product.title}, ${product.title} printing, printing service Kulai, printing service Johor Bahru, Johor printing, Malaysia printing`,
